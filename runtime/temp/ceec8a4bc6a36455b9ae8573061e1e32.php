<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\sky_sys\public/../application/sky\view\home\index.html";i:1493030711;s:73:"D:\phpStudy\WWW\sky_sys\public/../application/sky\view\layout\layout.html";i:1493030713;}*/ ?>
﻿<!DOCTYPE html>
<!--
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">抵押</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">征收</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">司法</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">出让</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">转让</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                    ...
                    <li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> 项目审核 </span>
                            <i class="menu-expand"></i>
                        </a>
                        <ul class="submenu">
                            <li>
                                <a href="elements.html">
                                    <span class="menu-text">我审核的项目</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">我报审的项目</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> 公共查询 </span>
                            <i class="menu-expand"></i>
                        </a>
                        <ul class="submenu">
                            <li>
                                <a href="elements.html">
                                    <span class="menu-text">项目查询</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">项目地图</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">个贷内部案例</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">土地交易案例</span>
                                </a>
                            </li>
                            <li>
                                <a href="elements.html">
                                    <span class="menu-text">对公归档报告</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="active">
                        <a href="index.html">
                            ...
                            <span class="menu-text"> 工作指引 </span>
                        </a>
                    </li>
                    <!--Dashboard-->
                    <li class="active">
                        <a href="index.html">
                            ...
                            <span class="menu-text"> 绩效填报 </span>
                        </a>
                    </li>
                    <!--UI Elements-->
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="elements.html">
                                    <span class="menu-text">报告号统计</span>
                                </a>
                            </li>
                            <li>
                                <a href="elements.html">
                                    <span class="menu-text">收费统计</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">已出项目统计</span>
                                </a>
                            </li>
                            <li>
                                <a href="tabs.html">
                                    <span class="menu-text">综合数据分析</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="databox radius-bordered databox-shadowed databox-graded">
                    <div class="databox-left no-padding bordered-left-2 bordered-palegreen">
                        <img src="__PUBLIC__/static/img/avatars/John-Smith.jpg" style="width:65px; height:65px;">
                    </div>
                            ...
                            <div class="tickets-container">
                                <ul class="tickets-list">
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                <img src="__PUBLIC__/static/img/avatars/adam-jansen.jpg" class="user-avatar">
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                <img src="__PUBLIC__/static/img/avatars/divyia.jpg" class="user-avatar">
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                <img src="__PUBLIC__/static/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                <img src="__PUBLIC__/static/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                <img src="__PUBLIC__/static/img/avatars/John-Smith.jpg" class="user-avatar">
...
<!-- /Page Body -->
    ...
    <script src="__JS__/charts/sparkline/jquery.sparkline.js"></script>
    <script src="__JS__/charts/sparkline/sparkline-init.js"></script>

    <!--Easy Pie Charts Needed Scripts-->
    <script src="__JS__/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="__JS__/charts/easypiechart/easypiechart-init.js"></script>

    <!--Flot Charts Needed Scripts-->
    <script src="__JS__/charts/flot/jquery.flot.js"></script>
    <script src="__JS__/charts/flot/jquery.flot.resize.js"></script>
    <script src="__JS__/charts/flot/jquery.flot.pie.js"></script>
    <script src="__JS__/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="__JS__/charts/flot/jquery.flot.orderBars.js"></script>
